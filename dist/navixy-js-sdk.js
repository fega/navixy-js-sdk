...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(346)))
...
var buildFullPath = __webpack_require__(350);
...
var _user = __webpack_require__(360);

var _user2 = _interopRequireDefault(_user);

var _dealer = __webpack_require__(361);

var _dealer2 = _interopRequireDefault(_dealer);

var _tracker = __webpack_require__(362);
...
var Navixy = {
    Api: function Api(config) {
        return new _main2.default(config, {
            user: _user2.default,
...
var API = function () {
    function API(config, parts) {
        _classCallCheck(this, API);

        this.apiUrl = '';
        this.hash = config && config.user && config.user.hash;

        this.CONFIG = _extends({}, _config2.default, config);
    ...
    _createClass(API, [{
        ...
        value: function setUser(user) {
            this.CONFIG.user = _extends({}, this.CONFIG.user, user);
            return this;
        }
    }, {
        key: 'getHash',
                            ...
                            case 0:
                                return _context.abrupt('return', new Promise(function (res, rej) {
                                    if (_this.hash) {
                                        ...
                                        _axios2.default.post(_this.apiUrl + 'user/auth', buildParams({
                                            login: _this.CONFIG.user.login,
                                            password: _this.CONFIG.user.password
                                        })).then(function (_ref2) {
                                            var data = _ref2.data;
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                return _context2.abrupt('return', _axios2.default.post('' + this.apiUrl + action, buildParams(params)).then(function (response) {
        ...
        key: 'inject',
        value: function inject(parts) {
            var _this2 = this;

            var modulesToInject = (0, _lodash.cloneDeepWith)(parts, function (node) {
                if (typeof node === 'function') {
                    return node.bind(_this2);
                }
            });
...
var mergeConfig = __webpack_require__(132);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(65), __webpack_require__(359)(module)))
...
function get_info() {
    return this.request('user/get_info');
}
...
//# sourceMappingURL=navixy-js-sdk.js.map